      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-12 px-12 w-full mx-auto max-w-[1440px]">
        ...
        <div className="space-y-4">
          ...
          <ul className="space-y-3">
            ...
            <li><Link to="/craftsmanship" className="text-surface/60 hover:text-surface transition-colors duration-300 font-body text-sm tracking-wide">Мастерство</Link></li>
            <li><Link to="/sustainability" className="text-surface/60 hover:text-surface transition-colors duration-300 font-body text-sm tracking-wide">Экология</Link></li>
            <li><Link to="/contact" className="text-surface/60 hover:text-surface transition-colors duration-300 font-body text-sm tracking-wide">Контакты</Link></li>
          </ul>
        </div>

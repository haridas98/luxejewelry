        ...
        {cartItems.length === 0 ? (
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
            ...
            <div className="lg:col-span-2 space-y-6">
              {cartItems.map((item) => (
                <div key={item.id} className="flex gap-6 p-6 bg-surface-container-low">
              ...
              <div className="bg-surface-container-low p-6 md:p-8 sticky top-24">
                ...
                <div className="space-y-4 mb-6">
                  <div className="flex justify-between text-sm">
                    <span className="text-on-surface-variant">Товары ({cartItems.reduce((sum, item) => sum + item.quantity, 0)} шт.):</span>
